  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <button
          className="md:hidden fixed bottom-4 right-4 bg-indigo-600 text-white p-3 rounded-full shadow-lg z-40 hover:bg-indigo-700 transition-colors"
        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50 p-4 md:p-6">
          ...
          {/* Component Content - Removed wrapping div to allow components to manage their own cards */}
          <ActiveComponent />
        </main>
      </div>
