    ...
    <div className="w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white rounded-xl shadow-md p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-800 mt-1">{loading ? "-" : cars.length}</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-500 text-sm font-medium">Approved Cars</p>
              <p className="text-2xl font-bold text-gray-800 mt-1">
                {loading ? "-" : cars.filter(car => car.status.toLowerCase() === 'approved').length}
              </p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-800 mt-1">
                {loading ? "-" : cars.filter(car => car.status.toLowerCase() === 'awaited').length}
              </p>
            </div>
